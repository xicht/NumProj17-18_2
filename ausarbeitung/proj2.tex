...
\]
Demnach ist für ausreichend kleine Schrittweite das Restglied $r_n$ ausreichend klein, so dass die Nullstelle für $F(x_n+1,.)$ mittels Newtonverfahren von $f(x_n)+f'(x_n)*h$ aus gefunden werden kann.
\subsection{Tests}
